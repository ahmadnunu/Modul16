...
Route::get('/file-url', function () {
    // Just prepend "/storage" to the given path and return a relative 
...
Route::get('/employees/{employeeId}/download', [EmployeeController::class, 'downloadFile'])->name('employees.download');
